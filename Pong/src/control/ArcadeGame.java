...
public class ArcadeGame extends ClassicGame {
    ...
    //changePlayers - also converts model.Player objects in control.ClassicGame class in to model.ArcadePlayer objects.
    public void changePlayers() {
        canvas.getChildren().removeAll(getPlayer1().getPlayer(), getPlayer2().getPlayer());
        ArcadePlayer player1 = new ArcadePlayer(25, 240, 1);
        ArcadePlayer player2 = new ArcadePlayer(755, 240, 2);
